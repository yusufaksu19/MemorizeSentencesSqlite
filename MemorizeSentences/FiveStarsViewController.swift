...
class FiveStarsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        sentencesList = Sentencesdao().getFiveStarsMemorisedSentences().shuffled()
